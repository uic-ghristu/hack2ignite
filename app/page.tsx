  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full">
        ...
        {/* hero section  */}
        <div ref={heroRef} className="relative h-screen w-full  flex flex-col items-center justify-start overflow-hidden">
          <Image
          ...
          {/* <div className="absolute minecraft-font text-xl text-white bottom-20">A Technical Hackathon organized by UIC, GHRISTU</div> */}
        </div>
